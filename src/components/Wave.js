      ...
      <div className="landing">
        <Container>
          <div className="hero-content">
            <h1>WE ARE TECHZONE SPESIALIZED IN TECHNOLOGIES</h1>
            <p>Web Development, Mobile Apps, Marketing Managment</p>
            <button>About Us</button>
          </div>
          <div className="landing-image">
            <img src="/images/home-landing-removebg-preview.png" alt="" />
          </div>
        </Container>
      </div>
